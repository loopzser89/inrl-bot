...
module.exports = {
    ...
    FREE_TXT : process.env.FREE_TXT || 'loopzbotmd',//nothing😉
    U_STATUS: process.env.U_STATUS || 'false', //to update profilesatus automaticily
    ALIVETXT: process.env.ALIVETXT || 'LOOPZ-BOT-MD', //nothing😛
    ...
    BOT_INFO : process.env.BOT_INFO || "LOOPZ-BOT-MD,INRL,https://i.imgur.com/DyLAuEh.jpg", // about the bot as img number for menu such plugins
    ...
    OWNER : process.env.OWNER || "919037858501",// bot owner
    ...
    SUDO: process.env.SUDO || "919037858501",// sudo numbers to manage bot it will been add more by,
